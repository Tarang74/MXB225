...
\begin{enumerate}
    ...
    \begin{align*}
        y_1\left( t \right) & = \sum_{n = 0}^\infty c_n t^{n + r_1} \\
        y_2\left( t \right) & = c y_1\left( t \right) \ln\left( x \right) + \sum_{n = 0}^\infty b_n t^{n + r_2}
    \end{align*}
    with \(c_0 \neq 0\) and \(b_0 \neq 0\), where \(c\) may be 0.
    \item When \(r_1 = r_2\):
    \begin{align*}
        y_1\left( t \right) & = \sum_{n = 0}^\infty c_n t^{n + r_1} \\
        y_2\left( t \right) & = y_1\left( t \right) \ln\left( x \right) + \sum_{n = 1}^\infty b_n t^{n + r_2}
    \end{align*}
    with \(c_0 \neq 0\).
\end{enumerate}
